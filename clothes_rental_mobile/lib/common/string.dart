class AppString {
  ...
  static const String baseURL = 'http://acme.com/api/';
  static String userName = '';
  static String userID = '';
  static const List<String> productComboImages = ['assets/images/eva_dress.jpg','assets/images/rensi_dress.jpg','assets/images/blood_dress.jpg'];
}
