...
import 'package:clothes_rental_mobile/present/screens/profile_order/components/order_paid_card.dart';
...
class TabBarViewPaidOrder extends StatelessWidget {
  const TabBarViewPaidOrder({
    super.key,
  });
